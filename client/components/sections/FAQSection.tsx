...
const FAQSection = () => (
  <section
    className="relative py-20 sm:py-24 lg:py-28 px-4 sm:px-6 lg:px-[130px] bg-background"
  ...
  >
    <div className="max-w-4xl mx-auto">
      <div className="text-center mb-12">
        ...
        <p className="text-muted-foreground font-manrope text-base sm:text-lg">
      ...
      <Accordion type="single" collapsible className="w-full space-y-4">
        ...
        >
          <AccordionTrigger className="text-left text-foreground font-manrope text-base hover:no-underline py-5">
            How is liquidation impossible?
          </AccordionTrigger>
          <AccordionContent className="text-muted-foreground font-manrope text-sm leading-relaxed pb-5">
